...
const errorKeys: Record<string, string> = {
  ...
  VALIDATION_FAILED: 'errors.validationFailed', RESOURCE_NOT_FOUND: 'errors.resourceNotFound', NOT_FOUND: 'errors.resourceNotFound', PROJECT_REVISION_CONFLICT: 'errors.projectConflict', REVISION_CONFLICT: 'errors.revisionConflict', IMPORT_FAILED: 'errors.importFailed', FILE_TOO_LARGE: 'errors.fileTooLarge',
